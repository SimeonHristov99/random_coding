...
последователност от топчета с еднакъв цвят с дължина поне 3, процедурата сеповтаря, в противен случай можете да се изстреля ново топче. Играта приключва
...
color1, color2, color3, ..., colorn (цветовете на топчетата)
Третият ред съдържа едно цяло числа:
Q (броя заявки)
...
ако играта е приключила (редицата от топчета е празна) и се извежда "Game Over".На последния ред се извежда крайното състояние на последователността от топчета,
